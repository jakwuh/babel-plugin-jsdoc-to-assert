    ...
    `var object = {␊
      ...
      method: function method(_method, y) {␊
        if (!(typeof _method === 'number')) {␊
          console._warn('actual.js:6:10: Expected `method` to have type number, got: ' + typeof _method);␊
        }␊
    ␊
        if (!(typeof y === 'string')) {␊
          console._warn('actual.js:6:10: Expected `y` to have type string, got: ' + typeof y);␊
        }␊
      }␊
    };`
